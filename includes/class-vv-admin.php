...
function vv_quiz_register_settings() {
    ...
    // Status / Visibility / CTA / Headers / Labels / Placeholders (All other fields follow in the main section)
...
function vv_render_details_page() {
    ...
    // NOTE: This assumes VV_QUIZ_DIR and get_file_data are defined correctly
    $all_headers = array('Version' => 'Version', 'Author' => 'Author', 'VersionNotes' => 'VersionNotes', 'Features' => 'Features');
    // Using VV_QUIZ_DIR defined in the main loader file
    $plugin_data_raw = get_file_data( VV_QUIZ_DIR . 'vapevida-quiz.php', $all_headers, 'plugin' );
    ...
    $version_notes = isset($plugin_data_raw['VersionNotes']) ? esc_html($plugin_data_raw['VersionNotes']) : 'No notes provided.';
    $features = isset($plugin_data_raw['Features']) ? esc_html($plugin_data_raw['Features']) : 'No Features To Be Added.';
    ...
    <div class="wrap">
        ...
        <div id="vv-admin-content-flex" style="display: flex; gap: 30px; margin-top: 20px;">
            ...
            </div> </div> <div id="vv-main-instructions" class="postbox" style="margin-top: 20px;">
            ...
            <div class="inside">
                ...
                <div style="background: #eef7ff; padding: 15px; border: 1px solid #cceeff; border-radius: 5px;">
                    ...
                    <ul style="margin-left: 10px; padding-left: 15px;">
                ...
                <div style="background: #f0fff0; padding: 15px; border: 1px solid #3c763d; border-radius: 5px; margin-top: 10px;">
                    ...
                    <p style="margin-left: 10px;">Για να εμφανιστεί ο νέος Όρος στο Quiz, πρέπει να είναι αντιστοιχισμένος σε τουλάχιστον ένα δημοσιευμένο προϊόν.</p>
                ...
                <div style="background: #f7f7f7; padding: 15px; border-left: 4px solid #e21e51; margin-top: 15px;">
                    ...
                    <p style="margin-top: 10px; font-style: italic;">Το σύστημα ελέγχει αν το προϊόν έχει το 'Τύπος Γεύσης' **ΚΑΙ** και τα δύο επιλεγμένα 'Συστατικά' ταυτόχρονα. Αν η επιλογή οδηγεί σε μηδενικά αποτελέσματα (π.χ. Καπνός + Φράουλα), το αποτέλεσμα είναι σωστά 0.</p>
                </div>
                </div>
        </div> </div>
    <?php
