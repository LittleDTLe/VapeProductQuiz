...
function vv_quiz_register_settings()
{
    ...
    add_settings_field(
        'btn_bg_hover_color',
        'Χρώμα Hover (Background)',
        'vv_quiz_color_field_callback',
        'vapevida-quiz-details',
        'vv_quiz_main_section',
        ['field_id' => 'btn_bg_hover_color', 'default' => '#4d40ff']
    );
    add_settings_field(
        'btn_txt_hover_color',
        'Χρώμα Hover (Κείμενο)',
...
function vv_quiz_color_field_callback($args)
{
    ...
    // The class 'vv-color-picker' is key for the JS to activate the color swatch
...
{
    // Check if we are on the correct admin page slug
    if ('toplevel_page_vapevida-quiz-details' !== $hook_suffix && 'vapevida-quiz-details' !== $hook_suffix) {
        return;
    }

    // Enqueue the necessary native WordPress scripts and styles
    wp_enqueue_style('wp-color-picker');
    wp_enqueue_script('wp-color-picker');

    // Inline script to initialize the color picker widget on our fields
...
?>
    <style>
        ...
        @media screen and (max-width: 768px) {
            ...
            /* Make guide boxes more mobile-friendly */
    ...
    <div class="wrap">
        ...
        <!-- TOP SECTION: Settings and Sidebar (Side by Side) -->
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <ul style="padding-left: 20px;">
                            <li>**Τύπος Γεύσης:** <code><?php echo esc_html($chosen_type_slug); ?></code></li>
        ...
        <div id="vv-guide-section" style="margin-top: 30px;">
            <div id="vv-main-instructions" class="postbox">
                ...
                <div class="inside">
                    ...
                    <h4><span class="dashicons dashicons-editor-code"></span> Κωδικός Εμφάνισης (Shortcode)</h3>
                        ...
                        <div style="background: #f0f0f0; padding: 15px; border-left: 4px solid #4a67b2; margin-bottom: 20px;">
                            ...
                            <div class="vv-shortcode-container" style="display: flex; align-items: center; justify-content: space-between; gap: 10px;">

                                <code id="vv-shortcode-code" style="flex-grow: 1; padding: 8px 10px; background: #fff; border: 1px dashed #ccc; font-weight: bold; border-radius: 3px;">
                                    <span style="vertical-align: middle; margin-right: 5px;"></span>[vapevida_quiz]
                                </code>

                                <button type="button"
                                    id="vv-copy-shortcode-btn"
