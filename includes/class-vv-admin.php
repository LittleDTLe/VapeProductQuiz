...
function vv_render_details_page() {
    ...
    <style>
        ...
        /* Shortcode Copy Button Styles */
        .vv-shortcode-container {
            position: relative;
            background: #f0f0f0;
            padding: 15px;
            border-left: 4px solid #4a67b2;
            margin-bottom: 20px;
        }
        
        .vv-shortcode-wrapper {
            display: flex;
            align-items: center;
            gap: 10px;
            margin-top: 10px;
        ...
        .vv-copy-button:hover {
            background: #135e96;
        }
        
        .vv-copy-button:active {
            background: #0a4b78;
        }
        
        .vv-copy-button.copied {
            background: #00a32a;
        }
        
        .vv-copy-button .dashicons {
            font-size: 16px;
            width: 16px;
            height: 16px;
            ...
            <div id="vv-main-instructions" class="postbox">
                ...
                <div class="inside">
                    ...
                    <div class="vv-shortcode-container">
                        ...
                        <div class="vv-shortcode-wrapper">
                            <code class="vv-shortcode-code">[vapevida_quiz]</code>
                            <button type="button" class="vv-copy-button" onclick="vvCopyShortcode(this)">
                                <span class="dashicons dashicons-clipboard"></span>Αντιγραφή
                            </button>
                        </div>
                    </div>
